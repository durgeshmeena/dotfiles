# Generated by Powerlevel10k configuration wizard on 2024-09-01 at 13:37 UTC.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    time                    # current time
    kubeps                  # kubecontext using kube-ps1 
    # =========================[ Line #2 ]=========================
    newline                 # \n
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
      ...
      # '*test*'  TEST    # to match your needs. Customize them as needed.
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_FOREGROUND=36	#36	#134
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_PREFIX=' \Uf10fe%f '
